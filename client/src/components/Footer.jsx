                ...
                <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                    <div className="md:max-w-96">
                        ...
                        <p className="mt-6 text-sm">
                            Empowering creators with AI-driven content solutions for a dynamic digital world.<br/>
                            Write smarter, create faster, and captivate your audience like never before.
                        </p>
                    </div>
