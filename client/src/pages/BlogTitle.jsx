...
const BlogTitle = () => {
  ...
  const blogCategories = ['General', 'Technology', 'Health', 'Business', 'Lifestyle', 'Travel', 'Education', 'Food']
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Generate a creative blog title for a keyword ${input} in the category ${selectedCategory}`
